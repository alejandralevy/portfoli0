...
export const projects: Record<Lang, Project[]> = {
  en: [
    ...
    { n: '03', name: 'Decentraland',      role: 'Software Engineer',                           year: '2022', desc: 'Top Scenes platform',                color: '#FF2D55' },
  ...
  es: [
    ...
    { n: '03', name: 'Decentraland',      role: 'Software Engineer',                           year: '2022', desc: 'Plataforma Top Scenes',                color: '#FF2D55' },
